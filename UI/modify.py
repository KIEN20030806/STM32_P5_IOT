...
class InfoScreen(BoxLayout):
    def __init__(self, **kwargs):
        ...
        # Main content: 4 small cards + 1 large card for weather
    ...
    def show_notification(self, instance):
        ...
        content.add_widget(Label(
            text="Đây là thông báo từ lập trình viên.",
            font_size='16sp',
            color=(0, 0, 0, 1)
        ))
        ...
        popup = Popup(title="Thông báo", content=content, size_hint=(0.8, 0.4))
